...
export const AboutHeaderData = {
    ...
    img3: headerimg3,
    title: 'About Us',
    subtitle: 'Browse our wide selection of mugs today.',
...
export const GuaranteeData = {
    id: 0,
    title: 'We Stand By Our Products',
    text: [
        {
            id: 0,
            text: "If for any reason you are unsatisfied, a full refund is available within 14 days of receipt of purchase."
        }
    ]
};
